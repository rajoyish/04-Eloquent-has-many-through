                                            ...
                                            <div class="relative overflow-x-auto">
                                                <table
                                                    ...
                                                    <thead
                                                        ...
                                                        <tr>
                                                            <th scope="col" class="px-6 py-3">Environment ID</th>
                                                            <th scope="col" class="px-6 py-3">Commit Has</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach ($project->deployments as $deployment)
                                                            <tr
                                                                ...
                                                                <td class="px-6 py-4">{{ $deployment->environment_id }}
                                                                </td>
                                                                <td scope="row"
                                                                    class="whitespace-nowrap px-6 py-4 font-medium text-gray-900 dark:text-white">
                                                                    {{ Str::limit($deployment->commit_hash, 20, '...') }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
